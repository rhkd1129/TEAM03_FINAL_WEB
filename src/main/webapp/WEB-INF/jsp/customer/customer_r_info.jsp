...
<head>
	...
	<script>
		...
		function foodInsert(fno) {
			...
			$.ajax({
				type : "get",
				url : "${pageContext.request.contextPath}/customer/customer_insert_order_table.do?fno="+fno + "&rno=" + rno,
				success : function(result) {
					$("#floatMenu2").html(result);
				}
			});
		...
		function foodDelete(bno) {
			...
			$.ajax({
				type : "get",
				url : "${pageContext.request.contextPath}/customer/customer_delete_order_table.do?bno="+bno,
				success : function(result) {
					$("#floatMenu2").html(result);
				}
			});
