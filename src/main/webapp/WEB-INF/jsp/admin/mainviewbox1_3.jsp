...
<head>
    ...
    <!-- css import -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/mainviewbox1_3css.css">
</head>
				...
				<div class="w3-content" style="max-width:1000px; margin-top: 70px;">
					<div class="mySlides" id="mlistmain">
						...
						<div class="mlistbox">
							...
							<div class="pagenum1">(임시)현재 승인 대기 수 : ${pager.totalRows}명</div>
...
function viewPaging(pageNo) {
   ...
   $.ajax({
      ...
      url : "${pageContext.request.contextPath}/admin/mainviewbox1_3.do?pageNo=" +pageNo,
...
$(".btnHome2").click(function(){
	$.ajax({
		type : "get",
		url : "${pageContext.request.contextPath}/admin/mainviewbox2.do",
		success : function(result){
			$("#adminmainpage").html(result);
		}
	})	
